...
function MovieForm() {
  ...
  let addMovie = async(e : MouseEvent) => {
    ...
    if (form.checkValidity()) {
      //get the username from local storage to send as a header
  ...
  return (
    <form className = "row g-3 needs-validation" id = "movie-form" >
        <h2 className="rounded-2">Add a Movie</h2>
        <div className="alert-container">
        </div>
        <div className='col-md-6'>
            <label htmlFor='formGroupExampleInput' className="form-label">Movie Title</label>
        ...
        <div className='col-md-6'>
            <label htmlFor='formGroupExampleInput' className="form-label" id='addon-wrapping'>Price</label>
        ...
        <div className='col-md-6'>
            <label htmlFor='formGroupExampleInput' className="form-label">Source URL</label>
        ...
        <div className='col-md-6'>
            <label htmlFor='formGroupExampleInput' className="form-label">Snapshot URL</label>
        ...
        <div className="col-6">
            <button type="submit" className="btn btn-primary" onClick={(e) => addMovie(e)}>Publish</button>
            <button type="reset" className="btn btn-warning">Reset</button>
            <button type="submit" className="btn btn-danger" onClick={(e) => cancelOperation(e)}>Cancel</button>
        </div>
